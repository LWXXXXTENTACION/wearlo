...
![Wearlo 系统总览](diagrams/system-overview.png)

[SVG 源文件](diagrams/system-overview.svg) · [画板 OpenAPI JSON](diagrams/system-overview.json)

## 服务边界

![Wearlo 服务边界](diagrams/service-boundaries.png)

[SVG 源文件](diagrams/service-boundaries.svg) · [画板 OpenAPI JSON](diagrams/service-boundaries.json)

Web 负责体验，Go 负责交易事实，Python 负责理解、检索和推荐。跨服务调用必须通过版本化 OpenAPI 或事件契约，Python 不得越过 Go 直接修改交易数据。
...
![Wearlo 数据架构](diagrams/data-architecture.png)

[SVG 源文件](diagrams/data-architecture.svg) · [画板 OpenAPI JSON](diagrams/data-architecture.json)

## 核心调用链

### AI 推荐

![AI 推荐时序](diagrams/ai-recommendation-sequence.png)

[Mermaid 源文件](diagrams/ai-recommendation-sequence.mmd)
...
![下单交易时序](diagrams/order-transaction-sequence.png)

[Mermaid 源文件](diagrams/order-transaction-sequence.mmd)
